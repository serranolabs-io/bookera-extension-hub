...
import { ExtensionMarketplaceModuleInstanceType, moduleInstances } from './api';
...
export const extensionMarketplaceModule = new BookeraModule<ExtensionMarketplaceModuleInstanceType>(
  DEFAULT_VERSION,
  'Extension Marketplace',
  description,
  new Tab('Extension Marketplace', 'puzzle', '', elementName, 'left'),
  genShortID(10),
  ['renderInSidePanel', 'renderInDaemon', 'renderInSettings', 'renderInPanel'],
